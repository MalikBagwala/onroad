...
export type MembershipTypeByEmailQuery = { __typename?: 'query_root', membershipTypeByEmail: { __typename?: 'MembershipTypeByEmailResponse', message: string, data: { __typename?: 'MemberType', type: string, hasPasskeys: boolean } } };
