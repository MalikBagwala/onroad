...
const Privacy = ({}: PrivacyType) => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to OnRoad.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to OnRoad, accessible from{' '}
            <a href="https://onroad.one" rel="external nofollow noopener" target="_blank">
              https://onroad.one
            </a>
          </p>
        </li>
      ...
      <ul>
        <li>By email: support@maalik.dev</li>
      </ul>
    </div>
  );
};
