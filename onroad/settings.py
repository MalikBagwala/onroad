...
PASSWORD_CHANGE_REQUEST_EXPIRATION_MINUTES = int(
    os.getenv("PASSWORD_CHANGE_REQUEST_EXPIRATION_MINUTES", "5")
)
REFRESH_TOKEN_EXPIRATION_MINUTES = int(
    os.getenv("REFRESH_TOKEN_EXPIRATION_MINUTES", "10080")
)  # 7 days
ACCESS_TOKEN_EXPIRATION_MINUTES = int(
    os.getenv("ACCESS_TOKEN_EXPIRATION_MINUTES", "10")
)  # 10 minutes
